...
const Hero = () => {
    ...
    return (
        <div className='flex flex-col gap-8 items-center justify-center h-[90vh] max-sm:px-6'>
            ...
            <p className='font-semibold max-sm:text-center'>Ready to watch? Create or login to your account</p>
            <button onClick={() => navigate('/netflix', scrollTo(0, 0))} className='bg-red-600 p-3 rounded border-none cursor-pointer font-bold text-sm'>Explore All</button>
        </div>
    )
}
