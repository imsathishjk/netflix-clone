...
const ReasonCards = () => {
    return (
        <div className='max-w-6xl mx-auto w-full pt-12 pb-5 px-4 bg-black'>
            ...
            <div className='flex gap-5 mt-12 flex-wrap lg:flex-nowrap'>
                ...
                <div className='bg-gradient-to-b border border-gray-700 grow from-black to-red-950 flex flex-col gap-3 rounded-md p-3'>
                    ...
                    <p className='text-sm lg:text-lg font-semibold text-gray-400'>Save your favourites easily and always have something to watch.</p>
                </div>
                <div className='bg-gradient-to-b border border-gray-700 grow from-black to-red-950 flex flex-col gap-3 rounded-md p-3'>
                    <h1 className='lg:text-xl font-semibold'>Watch everywhere</h1>
                    <p className='text-sm lg:text-lg font-semibold text-gray-400'>Stream unlimited movies and TV shows on your phone, tablet, laptop, and TV.</p>
                </div>
                <div className='bg-gradient-to-b border border-gray-700 grow from-black to-red-950 flex flex-col gap-3 rounded-md p-3'>
                    <h1 className='lg:text-xl font-semibold'>Create profiles for kids</h1>
                    <p className='text-sm lg:text-lg font-semibold text-gray-400'>Send kids on adventures with their favourite characters in a space made just for them — free with your membership</p>
                </div>
